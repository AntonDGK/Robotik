...
map = [[0,1000], [0,1000]]
target = (20, 30)#(980, 980)
init = (500,500)
obstacles = [[(100,0), (200,0), (200,600), (100,600)],[(600,1000), (600,600), (700, 600), (700, 1000)],[(650,0),(650, 300),(625,300),(625,0)],[(100,850),(100, 750),(200,750),(200,850)]]
target_radius = 20
...
def calcPath(robot, obstacles, target, map, steps):
    ...
    while(not collisionWithTarget(PathHistory[i], target) and i < 10000000):
        ...
        for pathIndex in range(0, len(PathHistory)):
            if(not PathHistoryChecked[pathIndex] and (PathHistoryDistance[pathIndex] < distance)):
